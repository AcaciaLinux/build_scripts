...
export PKG_NAME="xml-parser"
export PKG_VERSION="2.46"
export PKG_TARFILE="XML-Parser-2.46.tar.gz"
...
cd ${BUILD_CACHE_DIR}/XML-Parser-2.46

perl Makefile.PL 2>&1 | tee ${PKG_LOGDIR}/configure.log
