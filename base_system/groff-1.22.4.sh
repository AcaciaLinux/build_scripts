...
export PKG_NAME="groff"
export PKG_VERSION="1.22.4"
export PKG_TARFILE="groff-1.22.4.tar.gz"
...
PAGE=A4 ./configure --prefix=/usr 2>&1 | tee ${PKG_LOGDIR}/configure.log

make -j1 2>&1 | tee ${PKG_LOGDIR}/make.log
