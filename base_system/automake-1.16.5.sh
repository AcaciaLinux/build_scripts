...
export PKG_NAME="automake"
export PKG_VERSION="1.16.5"
export PKG_TARFILE="automake-1.16.5.tar.xz"
...
./configure --prefix=/usr --docdir=/usr/share/doc/automake-1.16.5 2>&1 | tee ${PKG_LOGDIR}/configure.log

make 2>&1 | tee ${PKG_LOGDIR}/make.log

make -j$(nproc) check 2>&1 | tee ${PKG_LOGDIR}/check.log 
