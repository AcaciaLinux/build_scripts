...
export PKG_NAME="pkg-config"
export PKG_VERSION="0.29.2"
export PKG_TARFILE="pkg-config-0.29.2.tar.gz"
...
./configure --prefix=/usr              \
            --with-internal-glib       \
            --disable-host-tool        \
            --docdir=/usr/share/doc/pkg-config-0.29.2 | tee ${PKG_LOGDIR}/configure.log
